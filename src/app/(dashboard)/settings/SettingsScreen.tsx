...
// הגדרות עסקיות — currently the financial section only (שיעור מע״מ).
// The rate is display-only for pricing: totals stay VAT-inclusive (D41).
  ...
  return (
    <div className="flex flex-col gap-5 p-[26px]" dir="rtl">
      <div>
        ...
        <p className="mt-1 text-sm font-semibold text-muted">{tenantName}</p>
      </div>

      <section className="bw-card max-w-xl">
        <CardTitle icon="finance" title="הגדרות כספיות" />
