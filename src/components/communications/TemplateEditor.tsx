...
import {
  ...
  blockMeta, makeBlock, usageLabel,
...
export type { EditorSeed } from "./editorShared";
...
export function TemplateEditor({
  ...
  // A NEW template is truly blank — no forced name, no booking-confirmation
  // subject, no seeded blocks. A gallery example arrives via `seed`.
  ...
  const [content, setContent] = useState<StructuredTemplateContent>(
    isContent(template?.draftContent) ? template.draftContent
      : isContent(seed?.content) ? seed.content
