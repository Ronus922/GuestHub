...
//
// SCOPE: this client touches /rate_plans ONLY, and only with GET and POST.
// It never calls DELETE (forbidden this milestone), never PUT, and never
// availability / restrictions / webhooks / bookings / properties / room_types —
// scripts/check-channex-rate-plans.mjs asserts that at the source level.
//
