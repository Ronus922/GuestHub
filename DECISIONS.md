...
## D153 — ייבוא OTA מדווח על מגבלות שהות ולעולם לא חוסם (2026-08-18)
...
## D154 — אכיפת מגבלות שהות בשכבת ה-DB: נבחנה ונדחתה (2026-08-18)
...
2. **טריגר היה חוסם בדיוק את שני המקרים הלגיטימיים** — ייבוא OTA (D153)
...
מתוך שישה נתיבי היצירה. הששי הוא ייבוא OTA, ועליו חלה D153.
